...
stats = {
    "opinions_count": len(opinions.index), #"opinions_count": opinions['opinion_id].count()
...
Dla {stats["pros_count"]} opinii podana została podana lista zalet a dla {stats["cons_count"]} opinii lista jego wad.
